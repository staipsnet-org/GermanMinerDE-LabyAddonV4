...
public class BalanceWidget extends TextHudWidget<TextHudWidgetConfig> implements
  ...
  public BalanceWidget(String id) {
    super(id);
  ...
  public void handle(BalancePacket packet) {
    ...
    bank.updateAndFlush(packet.getBank() != null ? format(packet.getBank())
        : Component.translatable("germanmineraddon.hudWidget.error"));
  }
