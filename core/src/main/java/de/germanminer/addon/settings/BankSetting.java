...
public class BankSubSetting extends Config {
  ...
  @TextFieldSetting
  private final ConfigProperty<String> bankCustomAccount1 = new ConfigProperty<>("DEFXXXXXXXX");
  @TextFieldSetting
  private final ConfigProperty<String> bankCustomAccount2 = new ConfigProperty<>("DEFXXXXXXXX");
  @TextFieldSetting
  private final ConfigProperty<String> bankCustomAccount3 = new ConfigProperty<>("DEFXXXXXXXX");
