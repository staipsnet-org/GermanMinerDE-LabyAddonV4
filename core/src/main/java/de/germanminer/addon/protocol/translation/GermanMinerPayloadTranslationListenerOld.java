...
public class GermanMinerPayloadTranslationListenerOld extends AbstractPayloadTranslationListener {
  ...
  public GermanMinerPayloadTranslationListenerOld(final Class<? extends GermanMinerPacket> clazz,
                                                  final String oldMessageKey, final TranslationSide side) {
    super(
        PayloadChannelIdentifier.create("minecraft", "lmc"),
